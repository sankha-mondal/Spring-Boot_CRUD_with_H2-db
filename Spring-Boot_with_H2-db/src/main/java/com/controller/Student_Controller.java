...
//=============================================================================================================================================
		...
		//  http://localhost:8585/student/getPassByEmail/{email}

		@GetMapping("/getPassByEmail/{email}")
		public ResponseEntity<Student> getPassByEmail(@PathVariable("email") String email) {
